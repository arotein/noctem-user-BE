...
public class RequestLogAspect {
    ...
    @Around("execution(* noctem.userService.domain..*Controller.*(..))")
    public Object requestControllerLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (clientInfoLoader.isAnonymous() == true) {
            ...
            log.info("[{}] {} {} {}", clientInfoLoader.getUserAccountId(), clientInfoLoader.getUserNickname(), clientInfoLoader.getUserRole(), clientInfoLoader.getUserEmail());
        }
